                 ...
                 children: <Widget>[
                  Row(
                    ...
                    children: <Widget>[
                      Text(
                        'Course en attente',
                        style: TextStyle(color: Color(0xFFFf89380) ,fontSize: 14,fontFamily: 'Quicksand')
                      ),
                      SizedBox(width: 4),
                      Icon(Icons.access_time,color: Color(0xFFFf89380))
                    ],
                  ), 
                  Row(
       ...
       children: <Widget>[
        ...
        text: TextSpan(
          children: <TextSpan>[
            ...
            TextSpan(text: "Pas encore disponible",
